...
********************************
All translations are added to ``cradmin_legacy/locale/``.
...
Commit the changes to the ``.po``-files in ``cradmin_legacy/locale/``.
...
This should change some ``.mo``-files in ``cradmin_legacy/locale/``.
Commit those files.
